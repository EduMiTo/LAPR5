...
import { GetFleetPlanningComponent } from './get-fleet-planning.component';
...
describe('GetFleetPlanningComponent', () => {
  let component: GetFleetPlanningComponent;
  let fixture: ComponentFixture<GetFleetPlanningComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ GetFleetPlanningComponent ]
    })
    .compileComponents();
    ...
    fixture = TestBed.createComponent(GetFleetPlanningComponent);
